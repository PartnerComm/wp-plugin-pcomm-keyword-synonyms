var qf_autocomplete = (function($, w) {
    ...
    function initAutoComplete() {
        ...
        $('#quickfind_submit_reg').click(function(e) {
            ...
            keys.userTyped = userTyped;

            logSearchWeight(keys);

            //alert('YOU TYPED: ' + userTyped);
            // alert('KEYS: ' + JSON.stringify(keys, null, 4));
